...
serviceRouter.get('/produktkategorie/gib/:category', function(request, response) {
    ...
    try {
        var result = produktkategorieDao.loadCat(request.params.category);
...
serviceRouter.post('/produktkategorie', function(request, response) {
    ...
    var errorMsgs=[];
    if (helper.isUndefined(request.body.oberkategorie)) 
        errorMsgs.push('oberkategorie fehlt');

    if (helper.isUndefined(request.body.unterkategorie))
        errorMsgs.push('unterkategorie fehlt');
    ...
    const produktkategorieDao = new ProduktkategorieDao(request.app.locals.dbConnection);
    try {
        var result = produktkategorieDao.create(request.body.oberkategorie, request.body.unterkategorie, request.body.bild);
...
serviceRouter.put('/produktkategorie', function(request, response) {
    ...
    const produktkategorieDao = new ProduktkategorieDao(request.app.locals.dbConnection);
    try {
        var result = produktkategorieDao.update(request.body.id, request.body.oberkategorie, request.body.unterkategorie, request.body.bild);
